...
<div class="row">
        ...
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="col-lg-7 col-md-12">
                   ...
                   <?php echo form_open_multipart('admin/home/editevent/'.$id.'/'); ?>
    ...
    <td align="center">Title</td>
          <td> <input type="text" name="title" value="<?php echo $event->title; ?>" class="form-control">  </td>
        </tr>
        
        <tr>
    
    <td align="center">Description</td>
          <td> <input type="text" name="details" value="<?php echo $event->details; ?>" class="form-control">  </td>
        </tr>
        
       <tr>
    
    <td align="center">Keywords and Tags</td>
          <td> <input type="text" name="keywords" value="<?php echo $event->keywords; ?>" class="form-control">  </td>
        </tr> 
    ...
    <td>
           <textarea class="ckeditor" name="content" cols="100" rows="20" id="editor1"><?php echo $event->content; ?></textarea>
...
<br><br>
       ...
       <center> <input type="submit" name="submit" value="Update Event" class="btn-default"> </center>                 
